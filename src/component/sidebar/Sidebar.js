...
export default function Sidebar({ handleToggleMenu }) {
  return (
    <div className='sidebar hidden md:block h-screen w-72 shrink-0 py-[35px] px-[41px] border-x-[1px] border-x-lighterGrey'>
        <div><img src={logo} alt="logo" className="w-40" /></div>
        <nav className='mt-[83px] flex flex-col space-y-8 about'>
            <NavLink onClick={handleToggleMenu} to='/' className='flex items-center space-x-9 text-lg'>
