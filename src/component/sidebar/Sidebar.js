...
import customer from '../../assets/activeCustomer.svg';
import shipment from '../../assets/activeshipment.svg';
    ...
    <div className='sidebar hidden md:block h-screen w-60 shrink-0 py-[35px] pl-[41px] border-x-[1px] border-x-lighterGrey'>
        ...
        <nav className='mt-[83px] side-b flex flex-col space-y-10 about h-[75vh] overflow-y-scroll '>
            <NavLink onClick={handleToggleMenu} to='/' className='flex items-center justify-between text-md max-w-[162px]'>
                ...
                <span className='block justify-self-start w-[70%] ml-[24px]'>Dashboard</span>
            </NavLink>
            <NavLink onClick={handleToggleMenu} to='/' className='flex items-center justify-between text-md max-w-[162px]'>
                <span className='block w-[30%]'>
                ...
                <span className='block justify-self-start w-[70%] ml-[24px]'>Admin</span>
            </NavLink>
            <NavLink onClick={handleToggleMenu} to='/' className='flex items-center justify-between text-md max-w-[162px]'>
                <span className='block w-[30%]'>
                    {pathname === '/' || (pathname.slice(0, 9) === '/shipment' && pathname.slice(0,15) !== '/shipmentdetail' ) ? <img src={customer} alt="customer" /> : 
                ...
                {pathname === '/' || (pathname.slice(0, 9) === '/shipment' && pathname.slice(0,15) !== '/shipmentdetail' ) ? 
                <span className='block justify-self-start font-semibold text-black w-[70%] ml-[24px]'>Customers</span> : <span className='block justify-self-start w-[70%] ml-[24px]'>Customers</span> }
            </NavLink>
            <NavLink onClick={handleToggleMenu} to='/' className='flex items-center justify-between text-md max-w-[162px]'>
                <span className='block w-[30%]'>
                {pathname.slice(0,15) === '/shipmentdetail' ? <img src={shipment} alt='shipment' /> :
                ...
                {pathname.slice(0,15) === '/shipmentdetail' ?
                <span className='block justify-self-start text-black font-semibold w-[70%] ml-[24px]'>Shipments</span> : <span className='block justify-self-start w-[70%] ml-[24px]'>Shipments</span>}
            </NavLink>
            <NavLink onClick={handleToggleMenu} to='/' className='flex items-center justify-between text-md max-w-[162px]'>
                <span className='block w-[30%]'>
                ...
                <span className='block justify-self-start w-[70%] ml-[24px]'>Tracking</span>
            </NavLink>
            <NavLink onClick={handleToggleMenu} to='/' className='flex items-center justify-between text-md max-w-[162px]'>
                <span className='block w-[30%]'>
                ...
                <span className='block justify-self-start w-[70%] ml-[24px]'>Documents</span>
            </NavLink>
            <NavLink onClick={handleToggleMenu} to='/' className='flex items-center justify-between text-md max-w-[162px]'>
                <span className='block w-[30%]'>
                    <svg width="18" height="18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className='block justify-self-start w-[70%] ml-[24px]'>Rates</span>
            </NavLink>
            <NavLink onClick={handleToggleMenu} to='/' className='flex items-center justify-between text-md max-w-[162px]'>
                <span className='block w-[30%]'>
                ...
                <span className='block justify-self-start w-[70%] ml-[24px]'>Quotes</span>
            </NavLink>
            <NavLink onClick={handleToggleMenu} to='/' className='flex items-center justify-between text-md max-w-[162px]'>
                <span className='block w-[30%]'>
                    <svg width="16" height="20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className='block justify-self-start w-[70%] ml-[24px]'>Invoice</span>
            </NavLink>
        </nav>
    </div>
  )
